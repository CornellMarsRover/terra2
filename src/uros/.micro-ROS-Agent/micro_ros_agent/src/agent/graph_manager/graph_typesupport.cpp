    ...
    : TopicDataType()
{
    ...
    type_support_ = get_message_typesupport_handle(
        type_support_, "rosidl_typesupport_fastrtps_cpp");
    callbacks_ =
        static_cast<const message_type_support_callbacks_t*>(type_support_->data);
    ...
    void* data, eprosima::fastrtps::rtps::SerializedPayload_t* payload)
{
    ...
    if (callbacks_->cdr_serialize(data, scdr)) {
        payload->encapsulation =
            (scdr.endianness() == eprosima::fastcdr::Cdr::BIG_ENDIANNESS) ? CDR_BE
                                                                          : CDR_LE;
...
ParticipantEntitiesInfoTypeSupport::getSerializedSizeProvider(void* data)
{
...
void ParticipantEntitiesInfoTypeSupport::deleteData(void* data) { (void)data; }

bool ParticipantEntitiesInfoTypeSupport::getKey(
    void* data, eprosima::fastrtps::rtps::InstanceHandle_t* handle, bool force_md5)
{
    (void)data;
    (void)handle;
    (void)force_md5;
...
MicrorosGraphInfoTypeSupport::MicrorosGraphInfoTypeSupport() : TopicDataType()
{
    type_support_ = rosidl_typesupport_cpp::get_message_type_support_handle<
...
void MicrorosGraphInfoTypeSupport::deleteData(void* data) { (void)data; }
