 ...
 *          Is used to gather and send information about the entities present within
 * a DDS domain, in the Agent's context.
 */
class ParticipantEntitiesInfoTypeSupport
    : public eprosima::fastdds::dds::TopicDataType
{
  public:
    ...
    virtual bool serialize(
        void* data, eprosima::fastrtps::rtps::SerializedPayload_t* payload) override;
