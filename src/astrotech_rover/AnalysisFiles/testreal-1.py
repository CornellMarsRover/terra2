...
async def main():
    ...
    fd = FdCanInterface(port="/dev/cu.usbmodemD8957AFF1", baud=115200)
    await fd.open()
    ...
    #double blue, raman
    raman = BDCController(can=fd, motor_id=0, can_id=21)
    led = BDCController(can=fd, motor_id=1, can_id=21)
    heat1 = BDCController(can=fd, motor_id=2, can_id=21)
    heat2 = BDCController(can=fd, motor_id=3, can_id=21)
