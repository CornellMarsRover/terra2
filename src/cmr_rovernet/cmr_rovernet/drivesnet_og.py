...
class CmdVelSubscriber(Node):
    ...
    def listener_callback(self, msg):
        ...
        # target_speed_left = scale_value(msg.twist.linear.y, -self.CONTROLLER_MAX_SPEED, self.CONTROLLEerR_MAX_SPEED, 
        ...
        logger.info("BL_SWERVE 6: " + str(wa3))
        logger.info("FR_SWERVE 7: " + str(wa1))
        logger.info("BR_SWERVE 8: " + str(wa4))
        logger.info("FL_SWERVE 5: " + str(wa2))
