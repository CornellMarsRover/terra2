...
async def main():
    ...
    ee6 = ServoController(can=fd, servo_id=6, can_id=3)
    ee7 = ServoController(can=fd, servo_id=7, can_id=3)
    ee8 = ServoController(can=fd, servo_id=8, can_id=3)
    ee9 = ServoController(can=fd, servo_id=9, can_id=3)
    ee10 = ServoController(can=fd, servo_id=10, can_id=3)
    ee11 = ServoController(can=fd, servo_id=11, can_id=3)
    ee12 = ServoController(can=fd, servo_id=12, can_id=24)
    ...
    try:
        ...
        await ee13.go_to_position(180)
        await ee15.go_to_position(180)
        await ee14.go_to_position(150)
