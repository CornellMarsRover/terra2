...
async def main():
    ...
    fd = FdCanInterface(port="COM7", baud=115200)
    await fd.open()
    ...
    # # MOTOR.move_motor_forward_ms(duration in milliseconds) -- moves a bdc motor forward for a certain duration in milliseconds
    # # MOTOR.move_motor_reverse(duration in seconds) -- moves a bdc motor in reverse for a certain duration in seconds
    # # MOTOR.move_motor_reverse_ms(duration in milliseconds) -- moves a bdc motor in reverse for a certain duration in milliseconds
