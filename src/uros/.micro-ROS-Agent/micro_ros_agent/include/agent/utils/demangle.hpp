...
class Demangle
{
  private:
     ...
     */
    static std::string _demangle_service_from_topic(const std::string& prefix,
  ...
  public:
     ...
     */
    static std::string demangle_if_ros_topic(const std::string& topic_name);
     ...
     */
    static std::string demangle_if_ros_type(const std::string& dds_type_string);
     ...
     */
    static std::string demangle_ros_topic_from_topic(const std::string& topic_name);

    /**
     * @brief   Demangle the service name for a given topic if it is part of a
     * service; otherwise, return empty.
     * @param   topic_name Topic to be demangled.
     * @returns The demangled service name.
     */

    static std::string demangle_service_from_topic(const std::string& topic_name);
    ...
    /**
     * @brief   Demangle the service type name if it is a ROS srv type; otherwise,
     * return empty.
     * @param   dds_type_name Type to be demangled.
     * @returns The demangled service type.
     */
    static std::string demangle_service_type_only(const std::string& dds_type_name);
     ...
     */
    static std::string identity_demangle(const std::string& name);
};
