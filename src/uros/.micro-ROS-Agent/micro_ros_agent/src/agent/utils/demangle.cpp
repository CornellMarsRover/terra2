...
std::string Demangle::demangle_if_ros_topic(const std::string& topic_name)
{
    return _strip_ros_prefix_if_exists(topic_name);
}

std::string Demangle::demangle_if_ros_type(const std::string& dds_type_string)
{
...
std::string Demangle::demangle_ros_topic_from_topic(const std::string& topic_name)
{
    return _resolve_prefix(topic_name, ros_topic_prefix);
}

std::string Demangle::_demangle_service_from_topic(const std::string& prefix,
...
std::string Demangle::demangle_service_from_topic(const std::string& topic_name)
{
    const std::string demangled_topic =
        demangle_service_reply_from_topic(topic_name);
...
std::string Demangle::demangle_service_request_from_topic(
    const std::string& topic_name)
{
    return _demangle_service_from_topic(ros_service_requester_prefix, topic_name,
                                        "Request");
}
...
std::string Demangle::demangle_service_reply_from_topic(
    const std::string& topic_name)
{
    return _demangle_service_from_topic(ros_service_response_prefix, topic_name,
                                        "Reply");
}

std::string Demangle::demangle_service_type_only(const std::string& dds_type_name)
{
    const std::string dds_prefix("dds_::");
    ...
    const std::string type_name =
        dds_type_name.substr(start, suffix_position - start);
    return type_namespace + type_name;
}

std::string Demangle::identity_demangle(const std::string& name) { return name; }
