...
GraphManager::GraphManager(eprosima::fastdds::dds::DomainId_t domain_id)
    : domain_id_(domain_id),
      ...
      participant_info_typesupport_(
          std::make_unique<eprosima::fastdds::dds::TypeSupport>(
              new graph_manager::ParticipantEntitiesInfoTypeSupport())),
      microros_graph_info_typesupport_(
          std::make_unique<eprosima::fastdds::dds::TypeSupport>(
              new graph_manager::MicrorosGraphInfoTypeSupport()))
{
    ...
    participant_.reset(
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()
            ->create_participant(domain_id_, participant_qos,
                                 participant_listener_.get(), par_mask));
    ...
    // Create topics
    ros_discovery_topic_.reset(participant_->create_topic(
        "ros_discovery_info", participant_info_typesupport_->get_type_name(),
        eprosima::fastdds::dds::TOPIC_QOS_DEFAULT));

    ros_to_microros_graph_topic_.reset(participant_->create_topic(
        "ros_to_microros_graph", microros_graph_info_typesupport_->get_type_name(),
        eprosima::fastdds::dds::TOPIC_QOS_DEFAULT));

    // Create datawriters
    datawriter_qos_ = eprosima::fastdds::dds::DATAWRITER_QOS_DEFAULT;
    ...
    datawriter_qos_.endpoint().history_memory_policy = eprosima::fastrtps::rtps::
    ...
    datawriter_qos_.durability().kind = eprosima::fastdds::dds::
        DurabilityQosPolicyKind::TRANSIENT_LOCAL_DURABILITY_QOS;

    eprosima::fastdds::dds::DataWriterQos ros_to_microros_datawriter_qos_ =
        datawriter_qos_;
    ros_to_microros_datawriter_qos_.history().kind =
        eprosima::fastdds::dds::HistoryQosPolicyKind::KEEP_LAST_HISTORY_QOS;
    ros_to_microros_graph_datawriter_.reset(publisher_->create_datawriter(
        ros_to_microros_graph_topic_.get(), ros_to_microros_datawriter_qos_));
    ...
    datareader_qos.endpoint().history_memory_policy = eprosima::fastrtps::rtps::
        MemoryManagementPolicy::PREALLOCATED_WITH_REALLOC_MEMORY_MODE;
    datareader_qos.reliability().kind =
        eprosima::fastdds::dds::ReliabilityQosPolicyKind::RELIABLE_RELIABILITY_QOS;
    datareader_qos.durability().kind = eprosima::fastdds::dds::
        DurabilityQosPolicyKind::TRANSIENT_LOCAL_DURABILITY_QOS;

    ros_discovery_datareader_.reset(subscriber_->create_datareader(
        ros_discovery_topic_.get(), datareader_qos, datareader_listener_.get()));
    ...
    microros_graph_publisher_ =
        std::thread(&GraphManager::publish_microros_graph, this);
}
    ...
    while (true) {
        {
            ...
            cv_.wait(lock, [this]() { return this->graph_changed_; });
            graph_changed_ = false;
        }
        ...
        graphCache_.get_node_names(&node_names, &node_namespaces, nullptr,
                                   &allocator);
        ...
        for (size_t i = 0; i < node_names.size; ++i) {
            ...
            if (RMW_RET_OK !=
                graphCache_.get_writer_names_and_types_by_node(
                    node_name, node_namespace,
                    uros::agent::utils::Demangle::demangle_ros_topic_from_topic,
                    uros::agent::utils::Demangle::demangle_if_ros_type, &allocator,
                    &writer_names_and_types)) {
                break;
            }
            ...
            for (size_t i = 0; i < writer_names_and_types.names.size; ++i) {
                ...
                entity_message.name =
                    std::move(std::string(writer_names_and_types.names.data[i]));

                for (size_t j = 0; j < writer_names_and_types.types[i].size; ++j) {
                    entity_message.types.emplace_back(
                        writer_names_and_types.types[i].data[j]);
                }
            ...
            rmw_names_and_types_t reader_names_and_types =
                rmw_get_zero_initialized_names_and_types();
            if (RMW_RET_OK !=
                graphCache_.get_reader_names_and_types_by_node(
                    node_name, node_namespace,
                    uros::agent::utils::Demangle::demangle_ros_topic_from_topic,
                    uros::agent::utils::Demangle::demangle_if_ros_type, &allocator,
                    &reader_names_and_types)) {
                break;
            }
            ...
            for (size_t i = 0; i < reader_names_and_types.names.size; ++i) {
                ...
                entity_message.name =
                    std::move(std::string(reader_names_and_types.names.data[i]));

                for (size_t j = 0; j < reader_names_and_types.types[i].size; ++j) {
                    entity_message.types.emplace_back(
                        reader_names_and_types.types[i].data[j]);
                }
            ...
            rmw_names_and_types_t service_server_names_and_types =
                rmw_get_zero_initialized_names_and_types();
            if (RMW_RET_OK !=
                graphCache_.get_names_and_types(
                    uros::agent::utils::Demangle::
            ...
            for (size_t i = 0; i < service_server_names_and_types.names.size; ++i) {
                ...
                entity_message.entity_type =
                    micro_ros_msgs::msg::Entity::SERVICE_SERVER;
                entity_message.name = std::move(
                    std::string(service_server_names_and_types.names.data[i]));

                for (size_t j = 0; j < service_server_names_and_types.types[i].size;
                     ++j) {
                    entity_message.types.emplace_back(
                        service_server_names_and_types.types[i].data[j]);
                }
            ...
            for (size_t i = 0; i < service_client_names_and_types.names.size; ++i) {
                micro_ros_msgs::msg::Entity entity_message;
                entity_message.entity_type =
                    micro_ros_msgs::msg::Entity::SERVICE_CLIENT;
                entity_message.name = std::move(
                    std::string(service_client_names_and_types.names.data[i]));

                for (size_t j = 0; j < service_client_names_and_types.types[i].size;
                     ++j) {
                    entity_message.types.emplace_back(
                        service_client_names_and_types.types[i].data[j]);
                }
            ...
            if (RMW_RET_OK != rmw_names_and_types_fini(&writer_names_and_types) ||
                ...
                RMW_RET_OK !=
                    rmw_names_and_types_fini(&service_server_names_and_types) ||
                RMW_RET_OK !=
                    rmw_names_and_types_fini(&service_client_names_and_types)) {
                std::cerr
                    << "Problem while freeing resources in Micro-ROS Graph Manager"
...
void GraphManager::add_participant(
    const eprosima::fastdds::dds::DomainParticipant* participant, bool from_microros,
    const std::string& enclave)
{
    ...
    if (qos.name().to_string() != "/" && from_microros) {
        ...
        get_name_and_namespace(qos.name().to_string(), isolated_node_name,
                               isolated_namespace);
        ...
        if (it == micro_ros_graph_datawriters_.end()) {
            ...
            eprosima::fastdds::dds::DataWriter* datawriter =
                publisher_->create_datawriter(ros_discovery_topic_.get(),
                                              datawriter_qos_);

            it = micro_ros_graph_datawriters_
                     .insert(std::make_pair(participant, datawriter))
                     .first;
        }
    ...
    const eprosima::fastdds::dds::DataWriter* datawriter)
{
    ...
    this->add_datawriter(datawriter_guid, topic_name, type_name, participant->guid(),
                         datawriter->get_qos());
}
...
{
    const rmw_gid_t datawriter_gid =
        rmw_fastrtps_shared_cpp::create_rmw_gid("rmw_fastrtps_cpp", datawriter_guid);
    ...
    const eprosima::fastdds::dds::DataReader* datareader)
{
    ...
    this->add_datareader(datareader_guid, topic_name, type_name, participant->guid(),
                         datareader->get_qos());
}
...
{
    const rmw_gid_t datareader_gid =
        rmw_fastrtps_shared_cpp::create_rmw_gid("rmw_fastrtps_cpp", datareader_guid);
    const rmw_gid_t participant_gid = rmw_fastrtps_shared_cpp::create_rmw_gid(
        "rmw_fastrtps_cpp", participant_guid);
    const rmw_qos_profile_t qos_profile = fastdds_qos_to_rmw_qos(reader_qos);

    graphCache_.add_entity(datareader_gid, topic_name, type_name, participant_gid,
                           qos_profile, true);
}
...
{
    const rmw_gid_t entity_gid =
        rmw_fastrtps_shared_cpp::create_rmw_gid("rmw_fastrtps_cpp", entity_guid);
    const rmw_gid_t participant_gid = rmw_fastrtps_shared_cpp::create_rmw_gid(
        "rmw_fastrtps_cpp", participant->guid());
    ...
    switch (entity_kind) {
        case dds::xrce::OBJK_DATAWRITER: {
            std::string isolated_node_name, isolated_namespace;
            get_name_and_namespace(qos.name().c_str(), isolated_node_name,
                                   isolated_namespace);
    ...
    const FastDDSQos& fastdds_qos)
{
    ...
    switch (fastdds_qos.reliability().kind) {
        case eprosima::fastdds::dds::ReliabilityQosPolicyKind::
    ...
    switch (fastdds_qos.durability().kind) {
        case eprosima::fastdds::dds::DurabilityQosPolicyKind::
    ...
    switch (fastdds_qos.liveliness().kind) {
        case eprosima::fastdds::dds::LivelinessQosPolicyKind::
    ...
    rmw_qos.liveliness_lease_duration.sec =
        fastdds_qos.liveliness().lease_duration.seconds;
    rmw_qos.liveliness_lease_duration.nsec =
        fastdds_qos.liveliness().lease_duration.nanosec;
...
void GraphManager::update_node_entities_info()
{
    ...
    if (ros_discovery_datareader_->take_next_sample(&entities_info, &sample_info) ==
        ...
        if (sample_info.instance_state ==
            eprosima::fastdds::dds::InstanceStateKind::ALIVE_INSTANCE_STATE) {
            graphCache_.update_participant_entities(entities_info);
        }
    }
}

void GraphManager::get_name_and_namespace(std::string participant_name,
...
GraphManager::ParticipantListener::ParticipantListener(GraphManager* graph_manager)
...
template <>
void GraphManager::ParticipantListener::process_discovery_info<
    ...
    const eprosima::fastrtps::rtps::ReaderDiscoveryInfo& reader_info)
{
    switch (reader_info.status) {
        ...
        case eprosima::fastrtps::rtps::ReaderDiscoveryInfo::DISCOVERED_READER: {
            ...
            graphManager_from_->add_datareader(
                reader_info.info.guid(), topic_name, type_name,
                iHandle2GUID(reader_info.info.RTPSParticipantKey()),
                reader_qos_conversion(reader_info.info.m_qos));
            break;
        }
        default: {
    ...
    const eprosima::fastrtps::rtps::WriterDiscoveryInfo& writer_info)
{
    switch (writer_info.status) {
        ...
        case eprosima::fastrtps::rtps::WriterDiscoveryInfo::DISCOVERED_WRITER: {
            ...
            graphManager_from_->add_datawriter(
                writer_info.info.guid(), topic_name, type_name,
                iHandle2GUID(writer_info.info.RTPSParticipantKey()),
                writer_qos_conversion(writer_info.info.m_qos));
            break;
        }
        default: {
...
GraphManager::DatareaderListener::DatareaderListener(GraphManager* graph_manager)
    : eprosima::fastdds::dds::DataReaderListener(), graphManager_from_(graph_manager)
{
}
