...
class GraphManager
{
  public:
    ...
    /**
     * @brief   Implementation of the notification logic that updates the micro-ROS
     * graph.
     */
    ...
    void add_participant(
        ...
        bool from_microros = true, const std::string& enclave = "/");
     ...
     */
    void add_datawriter(const eprosima::fastrtps::rtps::GUID_t& datawriter_guid,
                        const eprosima::fastdds::dds::DomainParticipant* participant,
     ...
     * @brief   Adds a DDS datawriter to the graph tree.
     * @param   datawriter_guid rtps::GUID_t of the datawriter to be added.
     * @param   topic_name Name of the topic to which the datawriter sends
     * information to.
     * @param   type_name Type name of the sent topic.
     * @param   participant_guid rtps::GUID_t of the participant which owns this
     * datawriter.
     ...
     */
    void remove_datawriter(const eprosima::fastrtps::rtps::GUID_t& datawriter_guid);
     ...
     */
    void add_datareader(const eprosima::fastrtps::rtps::GUID_t& datareader_guid,
                        const eprosima::fastdds::dds::DomainParticipant* participant,
     ...
     * @brief   Adds a DDS datareader to the graph tree.
     * @param   datareader_guid rtps::GUID_t of the datareader to be added.
     * @param   topic_name Name of the topic to which the datareader sends
     * information to.
     * @param   type_name Type name of the sent topic.
     * @param   participant_guid rtps::GUID_t of the participant which owns this
     * datareader.
     ...
     */
    void remove_datareader(const eprosima::fastrtps::rtps::GUID_t& datareader_guid);
  ...
  private:
        ...
        : public eprosima::fastdds::dds::DomainParticipantListener
    {
      public:
        /**
         * @brief   Constructor.
         * @param   graph_manager Pointer to the GraphManager object which owns this
         * ParticipantListener.
         */
        ParticipantListener(GraphManager* graph_manager);

      private:
        template <typename Info>
        void process_discovery_info(const Info& proxyData);
    ...
    class DatareaderListener : public eprosima::fastdds::dds::DataReaderListener
    {
      public:
         ...
         * DataReaderListener.
         */
        DatareaderListener(GraphManager* graph_manager);

      private:
        void on_data_available(eprosima::fastdds::dds::DataReader* /*sub*/) override;
    ...
    const rmw_qos_profile_t fastdds_qos_to_rmw_qos(const FastDDSQos& fastdds_qos);
     ...
     */
    void get_name_and_namespace(std::string participant_name, std::string& node_name,
    ...
    // Store a auxiliary publishers and datawriter for each participant created in
    // micro-ROS
    std::map<const eprosima::fastdds::dds::DomainParticipant*,
