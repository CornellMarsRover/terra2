...
- `44d23fc` Embed codebase map in README (`agupt0318 <anantg001@gmail.com>`)
- `4dfd17e` Add drive command mux safety core (`agupt0318 <anantg001@gmail.com>`)
- `507796d` Route keyboard teleop through drive mux (`agupt0318 <anantg001@gmail.com>`)
- `57a1395` Route legacy swerve through drive mux (`agupt0318 <anantg001@gmail.com>`)
- `6474d0a` Map secondary ROS domains (`agupt0318 <anantg001@gmail.com>`)
- `668662a` Launch mux with legacy drive backend (`agupt0318 <anantg001@gmail.com>`)
- `6f37c00` Use shared hardware drive backend (`agupt0318 <anantg001@gmail.com>`)
- `72032a6` Bound Gazebo drive check retries (`agupt0318 <anantg001@gmail.com>`)
- `73d5bb9` Update drive runtime topic maps (`agupt0318 <anantg001@gmail.com>`)
- `74442e1` Finish drive controller topic rename (`agupt0318 <anantg001@gmail.com>`)
- `772f889` Link current architecture maps (`agupt0318 <anantg001@gmail.com>`)
- `7767a4a` Publish converted teleop drive commands (`agupt0318 <anantg001@gmail.com>`)
- `791b6a7` Test mux convergence and estop in Gazebo (`agupt0318 <anantg001@gmail.com>`)
- `7e21df3` Select drive source in launch modes (`agupt0318 <anantg001@gmail.com>`)
- `807d110` Embed ROS map in README (`agupt0318 <anantg001@gmail.com>`)
- `85925f6` Map codebase package ownership (`agupt0318 <anantg001@gmail.com>`)
- `87117f8` Document drive mux topic contract (`agupt0318 <anantg001@gmail.com>`)
- `89def68` Refresh drive package topic maps (`agupt0318 <anantg001@gmail.com>`)
- `8ca7943` Refresh summarized drive topic names (`agupt0318 <anantg001@gmail.com>`)
- `967ad0a` Map canonical ROS runtime graph (`agupt0318 <anantg001@gmail.com>`)
- `9ae5afb` Document reserved drive command topic (`agupt0318 <anantg001@gmail.com>`)
- `a712fe8` Honor selected drive speed in legacy backend (`agupt0318 <anantg001@gmail.com>`)
- `afb8ed6` Remove hidden drive priority arbitration (`agupt0318 <anantg001@gmail.com>`)
- `b1f51c7` Add ROS drive command mux (`agupt0318 <anantg001@gmail.com>`)
- `b8b9dc3` Document selected drive command flow (`agupt0318 <anantg001@gmail.com>`)
- `cb0baa6` Delete bypassed point turn callback (`agupt0318 <anantg001@gmail.com>`)
- `cd83bac` Remove unused swerve backend values (`agupt0318 <anantg001@gmail.com>`)
- `f4e9e46` Consume only selected drive commands (`agupt0318 <anantg001@gmail.com>`)
- `f66a643` Remove inline README diagrams (`agupt0318 <anantg001@gmail.com>`)
- `fa28435` Rename selected drive state clearly (`agupt0318 <anantg001@gmail.com>`)
- `fcf1b3a` Rename raw drive controller topics (`agupt0318 <anantg001@gmail.com>`)

### 2026-09-10

- `2efc2c2` Document ROS simulation boundary (`agupt0318 <anantg001@gmail.com>`)
- `867062c` Correct ROS graph against source (`agupt0318 <anantg001@gmail.com>`)
- `c42533c` Clarify vertical ROS control flow (`agupt0318 <anantg001@gmail.com>`)

### 2026-09-13

- `0d2988b` Add risk-reducing planner transitions (`agupt0318 <anantg001@gmail.com>`)
- `19b469e` Ignore generated Gazebo validation artifacts (`agupt0318 <anantg001@gmail.com>`)
- `2817170` Bridge selected drive commands into Gazebo (`agupt0318 <anantg001@gmail.com>`)
- `38c7f6a` Add depth-enabled Gazebo obstacle course (`agupt0318 <anantg001@gmail.com>`)
- `4a406f9` Add simple Gazebo course launcher (`agupt0318 <anantg001@gmail.com>`)
- `67da498` Add simple autonomy simulation launcher (`agupt0318 <anantg001@gmail.com>`)
- `817ca11` Add shared rover simulation mesh (`agupt0318 <anantg001@gmail.com>`)
